                ...
                {props.activeProjectVariant.nbs &&
                    <Col>
                        <TooltipWrapper tooltipContent="Neubaustrecke">
                            <span title='Neubaustrecke' className='border border-white bg-primary text-white rounded-1 p-1'>NBS</span>
                        </TooltipWrapper>
                    </Col>
                }
                {props.activeProjectVariant.abs &&
                    <Col>
                        <TooltipWrapper tooltipContent="Ausbaustrecke">
                            <span title="Ausbaustecke" className='border border-white bg-primary text-white rounded-1 p-1'>ABS</span>
                        </TooltipWrapper>
